...
parent: Cryptography
date: 2021-04-12
summary: "Basics PRF를 통한 forward secrecy. Certificate를 통한 authentication. Encrypt ALPN(e.g. http/2) data Handshake/Record/. Layers Where is TLS?"
tags: ["cryptography", "http", "tls", "algorithm"]
nav_order: 3
---
