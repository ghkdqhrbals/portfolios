...
date: 2023-01-17
summary: "이전 테스트에서 발생한 성능이슈를 (1)Server 수평확장 및 (2)Docker 할당 리소스 추가로 10K HTTP request 테스트의 response까지 걸리는 시간을 110초에서 49초로 감소시켰다."
tags: ["project", "chat-server", "mysql", "postgresql", "index", "docker", "rest-api"]
nav_order: 15
---
