...
date: 2023-12-10
summary: "{: .important-title } 1.CI/CD 자동화 성공 그리고 실패 기존에 CI/CD 플로우는 하나의 머신에 자동으로 업로드하는 플로우를 가지고 있습니다(기존의 CI/CD 방법)."
tags: ["project", "chat-server", "kafka", "nginx", "ci-cd", "aws"]
nav_order: 39
---
