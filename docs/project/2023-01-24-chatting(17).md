...
date: 2023-01-24
summary: "Batch JPA batch JDBC batch 일반적인 성능비교 그래서 Chatting을 insert할 때는 어떤 방식이 좋을까? 이슈비교 그 외 종합 성능비교 그래프 결론 기능 설명 및 시연영상 현재는 4.2.0 버전이며 프론트 서버까지 모두 완료되었다!"
