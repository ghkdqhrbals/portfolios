...
date: 2023-03-06
summary: "서론 Multi Thread with Custom Exception, Not using @Async! 멀티스레딩 결과 1. 정상적인 api 요청 결과 2. db-유니크 키 violation 에러 핸들링 결과 신나는 코딩! 1."
tags: ["project", "chat-server", "completablefuture", "java", "kafka"]
nav_order: 22
---
