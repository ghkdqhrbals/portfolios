...
date: 2023-06-18
summary: "문제인식 현재 채팅서버 MSA 프로젝트로 확장성을 다양한 방법으로 증가하고 있습니다. 채팅서버 프로젝트에서 확장성 증가를 위한 구현 및 사용된 기술은 아래와 같아요."
tags: ["project", "chat-server", "spring-cloud", "postgresql", "redis", "kafka", "database"]
nav_order: 37
---
