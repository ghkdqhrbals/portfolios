...
date: 2023-03-11
summary: "서론 HTTP benchmark tool 제작 및 서버 부하 테스팅 0. 서론 현재까지 저는 INSERT 쿼리를 BatchSize=50 JDBC Batch로 변경하였습니다. 또한 인증서버도 멀티스레드로 구현하였습니다. 이제 직접 서버에 부하를 테스트해볼 차례에요."
tags: ["project", "chat-server", "go", "docker", "http", "benchmark", "nginx"]
nav_order: 23
---
