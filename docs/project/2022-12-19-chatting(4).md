...
date: 2022-12-19
summary: "추가내용 문제점2. 메모리상에서 유저데이터의 복제 해결 방법 이전 포스팅[[실시간 채팅방 구현(2)]](https://ghkdqhrbals.github.io/posts/chatting(2)/)에서 문제점2인 메모리상 유저데이터 복제가 일어난다고 기술했다."
tags: ["project", "chat-server", "kafka", "docker"]
nav_order: 4
---
