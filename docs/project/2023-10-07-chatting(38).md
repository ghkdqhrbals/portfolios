...
date: 2023-10-07
summary: "본 포스팅은 제가 아래의 이슈에서 이야기한 내용을 정리한 글이에요. {: .important-title } CI/CD 자동화 성공 그리고 실패 기존에 CI/CD 플로우는 하나의 머신에 자동으로 업로드하는 플로우를 가지고 있습니다(기존의 CI/CD 방법)."
tags: ["project", "chat-server", "kafka", "docker", "kubernetes", "ci-cd", "aws"]
nav_order: 38
---
