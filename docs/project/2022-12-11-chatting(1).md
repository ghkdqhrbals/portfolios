...
date: 2022-12-11
summary: "1. 현재의 단계 현재까지 version1 실시간 채팅방 구현을 위한 STOMP/Spring 연동이 완료되었다. 상세한 내용과 코드는 다음의 github 링크에서 확인할 수 있다. GITHUB : v1 동작 : 2."
tags: ["project", "chat-server", "kafka", "elasticsearch", "docker", "http"]
nav_order: 1
---
