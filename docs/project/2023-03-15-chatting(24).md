...
date: 2023-03-15
summary: "{: .important } HikariCP를 사용하던 중, 새로운 스레드에서 hikariDataSource.getConnection() 을 수행했지만 다른 스레드에서 사용하던 Connection 이 반환되었습니다."
tags: ["project", "chat-server", "completablefuture", "threadlocal", "postgresql", "transaction", "http"]
nav_order: 24
---
