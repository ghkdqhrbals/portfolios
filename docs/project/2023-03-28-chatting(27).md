...
date: 2023-03-28
summary: "API GateWay 선정 기존에 저는 nginx를 아래의 이유로 사용했어요. 통합 엔트리 포인트를 제공 리버스 프록시(백엔드 포인트 숨기기) 서비스 별 로드 밸런싱 높은 동시처리성능 1,2,3 번은 일반적인 Gateway 툴에서 제공하는 기능이구요."
tags: ["project", "chat-server", "spring-cloud", "msa", "nginx"]
nav_order: 27
---
