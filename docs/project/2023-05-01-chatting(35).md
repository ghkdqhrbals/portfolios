...
date: 2023-05-01
summary: "MSA 버전과 이전 모노 버전에서의 변경된 점과 성능 문제점 및 해결 과정을 설명하려 합니다. 일단 먼저 변경점을 아래와 같이 정리해보았어요. 1."
tags: ["project", "chat-server", "spring-cloud", "spring-boot", "redis", "kafka", "database"]
nav_order: 35
---
