...
date: 2023-01-16
summary: "랜덤값으로 test하는 code 10000개 rest api 트래픽 실행(110초 소요) 이제 동시 연결가능한 TCP 소켓을 필자의 맥북이 버틸 수 있는만큼 열어서 다량의 http request를 서버로 전송해볼려고 한다. Transport 설정을 잠깐 설명하자면 아래와 같다."
tags: ["project", "chat-server", "rest-api", "http"]
nav_order: 12
---
