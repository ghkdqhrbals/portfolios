...
date: 2022-12-17
summary: "프로젝트 수행 시 고려할 문제점 문제점1. 메모리 누수 front-back으로 기존 모노서버를 분산하던 중, JPA로 Chatting 을 저장할 때 메모리 누수가 관찰되었다. 먼저 Kafka를 통해 전달받는 메세지 구조는 다음과 같다."
tags: ["project", "chat-server", "kafka"]
nav_order: 2
---
