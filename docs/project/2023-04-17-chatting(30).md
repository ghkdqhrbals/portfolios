...
date: 2023-04-17
summary: "1. Saga Choreography Architecture v5 버전인 현재 구현진행/완료 중인 아키텍처입니다. 2. Saga Choreography 이벤트 성공값 클라이언트 반환 feat."
tags: ["project", "chat-server", "spring-cloud", "kafka", "msa", "saga"]
nav_order: 30
---
