...
date: 2023-04-13
summary: "인증/권한 설정 JWT 토큰을 강제로 expire 할 수 없다는 점이 까다로운것 같아요. 예로 비밀번호를 업데이트하면, 해당 비밀번호 이전의 토큰은 여전히 사용하능하다는 단점이 존재합니다."
tags: ["project", "chat-server", "spring-cloud", "java", "redis", "msa", "jwt"]
nav_order: 29
---
