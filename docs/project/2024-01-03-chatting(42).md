...
date: 2024-01-03
summary: "성능개선 이전에 기존 서비스의 성능측정 10분간 POST /api-chat/chat 의 퍼포먼스를 ramp-up VUSER 300 으로 측정하였습니다. 아래의 테이블은 Thread warm up 이전과 이후 차이를 관찰합니다. 그리고 그래프는 웜업 이후의 그래프입니다."
tags: ["project", "chat-server", "postgresql"]
nav_order: 42
---
