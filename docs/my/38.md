...
date: 2025-10-02
summary: "실수로 인해 발생하는 장애를 방지하기 위해 개인적인 규칙과 셋업을 기록합니다. SQL 쿼리는 직접 짠 뒤 AI 검증 - 한 명 이상 같이 검증 - 실행시간 남기고 - update, delete 는 select 로 한 번 보고 explain 건 뒤 수행한다."
tags: ["retrospective", "spring-boot", "mysql"]
parent: 개발자 일기
---
