...
parent: OS
date: 2021-01-20
summary: "Direct Mapping Advantage Fast as only tag field matching is required while searching for a word It is comparatively less expensive than associative..."
tags: ["computer-science", "operating-system", "index", "performance"]
