...
parent: OS
date: 2021-01-25
summary: "Difference in concept Process program that currently running when program in disk load on memory, it become process Thread basic unit of CPU to execute..."
tags: ["computer-science", "operating-system", "gc", "go", "performance"]
