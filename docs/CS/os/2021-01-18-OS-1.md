...
parent: OS
date: 2021-01-18
summary: "Computer Architecture CPU-CORE Register : Data storage that needed for CU and ALU PC (Program Counter) : store address which is next instruction set AC..."
tags: ["computer-science", "operating-system", "index"]
