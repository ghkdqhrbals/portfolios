...
parent: 도커와 쿠버네티스
date: 2022-03-10
summary: "Dockerfile Below is my Banking Server backend Dockerfile. Here, I'm going to explain each steps. Lets start from the beginning! Build Stage FROM golang:1."
tags: ["docker", "infra", "go", "postgresql", "database", "kubernetes", "http"]
nav_order: 1
---
