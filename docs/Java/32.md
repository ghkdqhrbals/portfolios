...
title: Spring batch
date: 2025-05-21
summary: "주문 관련 배치 작업 중 변경감지 안되서 정리함. 현재는 Spring batch 에서 reader processor writer step 중 ItemReader 내부에서 last read id + offset size 로 Pagination 해서 읽어오고 있음."
tags: ["java", "backend", "spring-batch", "mysql", "database", "index", "performance"]
auto_translate: true
translation_en: |
