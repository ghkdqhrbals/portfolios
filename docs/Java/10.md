...
parent: Server
date: 2023-08-08
summary: "JPA 양방향 전파 설정 3 가지 경우 테스트에 대해 정리한 글입니다."
auto_translate: true
translation_en: |
  ## Test code
  ...
  class TeamRepositoryTest extends ExperimentalTest{
      @Test
      @DisplayName("[CASE-1] When only Team has Member")
      void func1(){
      ...
      @Test
      @DisplayName("[CASE-2] When only Member has Team")
      void func2(){
      ...
      @Test
      @DisplayName("[CASE-3] When both Member and Team have each other")
      void func3(){
