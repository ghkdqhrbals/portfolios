...
tags: ["java", "backend", "redis-stream", "redis", "kafka", "debezium", "index"]
auto_translate: true
translation_en: |
  ...
  1. Kafka automatically manages connected consumers, but Redis Stream does not have that.
      ...
      There is another point to watch out for when writing a rebalancing scheduler in a multi-pod environment, but this would get too long, so I will leave a [link to the previous post](https://ghkdqhrbals.github.io/portfolios/docs/Java/30/).
