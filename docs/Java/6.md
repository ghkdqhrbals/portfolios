...
tags: ["java", "backend", "jvm", "algorithm"]
auto_translate: true
translation_en: |
  {: .note}
  > Before reading this post, it will help to read [https://ghkdqhrbals.github.io/portfolios/docs/Java/5](https://ghkdqhrbals.github.io/portfolios/docs/Java/5), which explains why the Reactor model appeared.
  ...
  * [https://medium.com/geekculture/a-tour-of-netty-5020ecee5494](https://medium.com/geekculture/a-tour-of-netty-5020ecee5494)
  ...
  It is similar to the Master-slave Reactor model explained in the previous [Reactor Model](https://ghkdqhrbals.github.io/portfolios/docs/Java/5/#24-master-slave-reactor-model-multiple-reactors-and-threads), but slightly different. Let us look at it now.
  ...
  If we match it with the [Master-slave Reactor model](https://ghkdqhrbals.github.io/portfolios/docs/Java/5/#24-master-slave-reactor-model-multiple-reactors-and-threads):
