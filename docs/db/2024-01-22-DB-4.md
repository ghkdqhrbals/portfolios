...
parent: RDBMS
date: 2024-01-22
summary: "Postgresql vs Mysql 인덱스 최적화 방법을 말씀드리기 전에 데이터 저장에 있어 Mysql 와 Postgresql 의 인덱싱 차이점을 먼저 말씀드리겠습니다. Mysql 의 PK 인덱스는 클러스터링 인덱스로 되어있습니다."
tags: ["database", "mysql", "postgresql", "index"]
nav_order: 5
---
