...
parent: RDBMS
date: 2022-11-20
summary: "모든 데이터베이스는 아래의 트랜젝션 격리 수준을 가진다. READ UNCOMMITTED READ COMMITTED REPEATABLE READ SERIALIZABLE 이해를 돕기 위해 A,B 트랜젝션이 동시에 특정 데이터에 진입할 때를 가정한다. 1."
tags: ["database", "postgresql", "transaction", "isolation"]
grand_parent: CS정리
nav_order: 3
---
