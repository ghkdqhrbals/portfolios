...
parent: RDBMS
date: 2022-11-20
summary: "이 포스팅은 ACID, CAP, BASE 이론들을 설명하는 글입니다. 대부분의 어플리케이션은 데이터의 정합성을 보장하기 위해서 데이터 베이스를 이론(ACID, CAP, BASE 이론)에 따라 관리합니다."
tags: ["database", "postgresql", "mongodb", "transaction", "isolation"]
nav_order: 4
---
