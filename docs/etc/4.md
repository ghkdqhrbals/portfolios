...
layout: default
title: 아무거나 기록
summary: "SSL 인증서 적용 방법 sudo openssl pkcs12 -export -in fullchain.pem -inkey privkey.pem -out keystore.p12 -name ttp -CAfile chain."
tags: ["etc", "java", "redis", "kafka", "database", "kubernetes", "tls"]
parent: 기타
nav_order: 100
---
