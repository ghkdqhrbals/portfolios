...
summary: "Design rules for restful URI URI needs to show information of resource resource should be nouns rather than verbs, lowercase letters rather than..."
parent: API 아키텍처
nav_order: 2
---
