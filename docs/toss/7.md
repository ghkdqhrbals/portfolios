...
parent: 토스 러너스 하이 2기
date: 2025-12-30
summary: "Cursor pagination 메세지 조회 모니터링 페이지 제작 기존에 redis stream 메세지 모니터링이 너무 불편했습니다. Intellij 로 redis cluster 접속해서 stream 확인하는데 메세지 수가 많으면 뒤에 메세지 확인하는게 너무 느렸습니다."
