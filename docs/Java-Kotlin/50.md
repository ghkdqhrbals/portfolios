...
parent: Java-Kotlin
date: 2026-01-24
summary: "JIT 컴파일러 탄생배경 및 정의 자바는 bytecode 명령어로 이루어진 .class 까지 javac 로 컴파일링 한 뒤 JVM 위에서 한 줄씩 bytecode binary code 로 interpreting 한다."
tags: ["java", "kotlin", "backend", "spring-boot", "jvm", "jit", "graalvm"]
---
