...
date: 2025-08-10
summary: "Java Virtual Thread vs Goroutine 이전에 Java 의 native thread 와 goroutine 차이점을 정리한 적이 있고 그냥 다시 상기하는 차원에서 정리한다. ."
parent: Java-Kotlin
---

# Java Virtual Thread vs Goroutine

이전에 Java 의 native thread 와 goroutine 차이점을 정리한 적이 있고 그냥 다시 상기하는 차원에서 정리한다. [2022-09-18-thread-goroutine](/docs/go/2022-09-18-thread-goroutine/).
