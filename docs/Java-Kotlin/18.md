...
date: 2024-09-06
summary: ": https://kotlinlang.org/docs/sealed-classes.html enum 이랑 거의 똑같은데 좀 더 유연합니다. ENUM 은 constant 이지만, Sealed class 는 아래처럼 외부에서 원하는 값을 파라미터로 넣어서 반환시켜줄 수 있어요."
tags: ["java", "kotlin", "backend"]
parent: Java-Kotlin
nav_order: 18
---
