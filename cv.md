...
안녕하세요. 교촌 주문, 결제, 멤버십 서비스에서 최대 4,000 RPS의 트래픽을 처리하고, Spring Boot/Kotlin 기반 고가용성 백엔드 시스템을 설계, 운영, 자동화해 온 백엔드 엔지니어 황보규민입니다.

최근에는 Codex로 코드 분석, 설계, 구현, 리팩터링, 테스트, 문서화 등 다양한 개발 작업을 진행하며 AI 에이전트 기반 워크플로우를 확장하고 있습니다. 또한 CDC 파이프라인 구축, 대용량 배치 95.4% 성능 개선, 브랜드별 CI/CD, Redis Stream 메시징 설계를 통해 운영 자동화와 시스템 효율을 높여왔습니다.

운영 중 발견한 성능 병목과 알림 누락의 원인을 분석하고, 같은 문제가 반복되지 않도록 시스템을 개선해 왔습니다.

## EXPERIENCE
* Backend Engineer(**FOODDASH**) 2024.04.15 ~ 2025.11.30

  * 600만+ 회원, MAU 77만 교촌치킨을 포함한 자담, 읍천리 등 여러 멀티프렌차이즈의 주문, 결제, 멤버십 백엔드를 개발, 무중단 운영.
